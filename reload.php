                ...
                <div class="card-body" style="margin-top: 10px;">
                    <div class="row">
                        <div class="col">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-4"><label class="form-label">Card Owner</label><input type="text"
                                            style="margin-left: 30px;"></div>
                                    <div class="col-md-4"><label class="form-label">Amount</label><input type="text"
                                            style="margin-left: 30px;"></div>
                    ...
                    <div class="col">
                        <div class="container" style="margin-top: 20px;">
                            <div class="row">
                                <div class="col-md-4"></div>
                                <div class="col-md-4"><button class="btn btn-primary" type="button"
                                        style="margin-left: 53%;">Proceed</button></div>
                                <div class="col-md-4"></div>
                            </div>
                        </div>
                    </div>
