    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="booking-1.html"><i
                                class="fas fa-table"></i><span>Cancellation</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="Reload.html"><i
                                class="far fa-user-circle"></i><span>Reloads</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="register.html"><i
                                class="fas fa-user-circle"></i><span>Bookings</span></a></li>
                </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Add Payment method</h3>
                </div>
                            ...
                            <form accept-charset="UTF-8" action="card.php" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_bQQaTxnaZlzv4FnnuZ28LFHccVSaj" id="payment-form" method="post">
                                ...
                                <div class='form-row'>
                                    <div class='col-xs-12 form-group required'>
                                        ...
                                        <input class='form-control' size='4' placeholder='John Doe' type='text'>
                                    </div>
                                </div>
                                <div class='form-row'>
                                    <div class='col-xs-12 form-group card required'>
                                        <label class='control-label'> Card Number</label>
                                        <input autocomplete='off' class='form-control card-number' placeholder='Ex. 45633 2355 4624' size='20' type='text'>
                                    </div>
                                </div>
                                <div class='form-row'>
                                ...
                                <div class='form-row'>
                                    <div class='col-md-12 error form-group hide'>
                                        <div class='alert-danger alert' style="font-size:12px; color:red;">
